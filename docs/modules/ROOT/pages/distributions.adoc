...
:keywords: NormalDist, ChiSqDist, probability density function, cumulative distribution function, inverse cdf, Gaussian uncertainty propagation, Mahalanobis distance, Erf, Gamma function, chi-squared distribution, normal distribution
...
This page focuses on usage; for the underlying formulas and algorithms, see xref:normal-distribution-algorithm.adoc[], xref:chi-squared-distribution-algorithm.adoc[], xref:gamma-function.adoc[], and xref:error-function.adoc[].
